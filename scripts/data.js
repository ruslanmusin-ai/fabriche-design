...
const sharedCollectionMillings = ["Барберра", "Палладио", "Персиана", "Роана", "Симфония", "струны", "Тоскана"].map((title, index) => ({
  title,
  ...
  cards: [
    {
      ...
      description:
        "Лучистый белый — сияющий белый оттенок. Напоминает о песке пляжей и бликах на воде.",
    ...
    },
    {
      ...
      description:
        "Лунный свет — мягкий, серебристый оттенок. Передаёт прохладу горных рек и лунный свет над холмами.",
      kitchens: buildSequentialCollectionKitchens("piedmont", "Piedmont", 21),
      millings: sharedCollectionMillings,
    },
    {
      id: "crystal-gray",
      title: "Кристальный серый",
      place: "Позитано",
      ...
      description:
        "Кристальный серый — прозрачный, лёгкий серый оттенок. Передаёт игру света на воде и тени от домов.",
      kitchens: buildSequentialCollectionKitchens("positano", "Positano", 22),
      millings: sharedCollectionMillings,
    },
    {
      id: "castle-wall",
      title: "Замковая стена",
      place: "Амальфи",
      ...
      description:
        "Замковая стена — тёплый, землистый оттенок. Передаёт цвет старинных стен и скал побережья.",
      kitchens: buildSequentialCollectionKitchens("amalfi", "Amalfi", 18),
      millings: sharedCollectionMillings,
    },
    {
      id: "northern-droplet",
      title: "Северная капля",
      place: "Лацио",
      ...
      description:
        "Северная капля — мягкий, прозрачный оттенок. Напоминает о каплях утренней росы и бризе с моря.",
    ...
    },
    {
      ...
      description:
        "Призрачный серый — приглушённый серый оттенок. Отражает древность архитектуры и прохладу тенистых улиц.",
    ...
    },
    {
      ...
      description:
        "Тень — глубокий, приглушённый оттенок. Передаёт таинственность горных пейзажей и историческую глубину региона.",
    ...
    },
    {
      ...
      description:
        "Новая пшеница — тёплый, золотистый оттенок. Напоминает о спелых колосьях и солнечном свете, идеально передаёт тепло юга.",
      kitchens: buildSequentialCollectionKitchens("sorrento", "Sorrento", 20),
      millings: sharedCollectionMillings,
    },
    {
      id: "autumn-glaze",
      title: "Осенняя глазурь",
      place: "Сицилия",
      ...
      description:
        "Осенняя глазурь — тёплый, слегка дымчатый оттенок. Отражает закаты над морем и величие вулкана.",
      kitchens: buildSequentialCollectionKitchens("sicily", "Sicily", 14),
      millings: sharedCollectionMillings,
    },
    {
      id: "china-blue",
      title: "Китайский синий",
      place: "Венето",
      ...
      description:
        "Китайский синий — глубокий синий оттенок. Напоминает о водах Адриатики и вечернем небе над Венецией.",
  ...
  colors: [
    {
      ...
      millings: ["Барберра", "Палладио", "Персиана", "Роана", "Симфония", "струны", "Тоскана"],
    },
    {
      id: "ambra",
      name: "Ambra",
